...
import { evaluateRefreshSession, RefreshSession, } from '../../../src/modules/identity/domain/index.js';
...
describe('refresh token rotation logic', () => {
    ...
    it('rejects expired active session', () => {
        const outcome = evaluateRefreshSession(session({ expiresAt: new Date('2025-12-31T23:59:59Z') }), now);
