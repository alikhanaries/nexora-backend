...
import type { CreateReturn } from '../application/create-return.js';
import type { GetReturn } from '../application/get-return.js';
import type { ListReturns } from '../application/list-returns.js';
import type { ReceiveReturn } from '../application/receive-return.js';
import type {
  ApproveReturn,
  CancelReturn,
  CompleteReturn,
  RejectReturn,
} from '../application/transition-return.js';
...
import {
  ...
  returnListSuccessResponseSchema,
  returnSuccessResponseSchema,
} from './return.schemas.js';

export interface ReturnRoutesDependencies {
  readonly createReturn: CreateReturn;
  readonly getReturn: GetReturn;
  readonly listReturns: ListReturns;
  readonly approveReturn: ApproveReturn;
  readonly receiveReturn: ReceiveReturn;
  readonly completeReturn: CompleteReturn;
  readonly rejectReturn: RejectReturn;
  readonly cancelReturn: CancelReturn;
}

const returnRoutes: FastifyPluginAsync<ReturnRoutesDependencies> = async (app, deps) => {
  ...
  typed.post(
    ...
    async (request) => {
      ...
      return { success: true as const, data: toReturnResponse(returnDetail) };
    },
  );
  ...
  typed.post(
    '/api/v1/returns/:returnId/complete',
    {
      schema: {
        tags: ['Returns'],
