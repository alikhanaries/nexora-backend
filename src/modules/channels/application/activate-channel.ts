...
export interface ActivateChannelInput {
...
export interface ActivateChannelResult {
  readonly channel: Channel;
}

export interface ActivateChannelDependencies {
...
export class ActivateChannel {
  constructor(private readonly deps: ActivateChannelDependencies) {}

  async execute(input: ActivateChannelInput): Promise<ActivateChannelResult> {
