...
export interface SuspendChannelResult {
  readonly channel: Channel;
}

export interface SuspendChannelDependencies {
...
export class SuspendChannel {
  constructor(private readonly deps: SuspendChannelDependencies) {}

  async execute(input: SuspendChannelInput): Promise<SuspendChannelResult> {
