...
export interface ApiKeysModuleDependencies {
...
export function createApiKeysModule(deps: ApiKeysModuleDependencies) {
...
export type ApiKeysModule = ReturnType<typeof createApiKeysModule>;
