...
import type { ActivateTotpFactorUseCase } from '../application/use-cases/activate-totp-factor.js';
import type { StartTotpEnrollmentUseCase } from '../application/use-cases/start-totp-enrollment.js';
import type { UseRecoveryCodeUseCase } from '../application/use-cases/use-recovery-code.js';
import type { VerifyMfaUseCase } from '../application/use-cases/verify-mfa.js';
import type { VerifyTotpEnrollmentUseCase } from '../application/use-cases/verify-totp-enrollment.js';

export interface MfaRoutesOptions {
  readonly startTotpEnrollment: StartTotpEnrollmentUseCase;
  readonly verifyTotpEnrollment: VerifyTotpEnrollmentUseCase;
  readonly activateTotpFactor: ActivateTotpFactorUseCase;
  readonly verifyMfa: VerifyMfaUseCase;
  readonly useRecoveryCode: UseRecoveryCodeUseCase;
}
...
const mfaRoutes: FastifyPluginAsync<MfaRoutesOptions> = async (app, options) => {
