import type { PermissionPattern } from './permission-pattern.js';
import type { SystemRoleKey } from './role.js';

export interface SystemRoleTemplate {
  readonly systemKey: SystemRoleKey;
  readonly name: string;
  readonly patterns: readonly PermissionPattern[];
}
...
export function findSystemRoleTemplate(systemKey: SystemRoleKey): SystemRoleTemplate {
