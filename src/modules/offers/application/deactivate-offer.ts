...
export interface DeactivateOfferInput {
...
export interface DeactivateOfferResult {
  readonly offer: OfferDto;
}

export interface DeactivateOfferDependencies {
...
export class DeactivateOffer {
  constructor(private readonly deps: DeactivateOfferDependencies) {}

  async execute(input: DeactivateOfferInput): Promise<DeactivateOfferResult> {
