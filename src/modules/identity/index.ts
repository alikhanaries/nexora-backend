...
import { createAuthRoutes, type AuthRouteDeps } from './presentation/auth.routes.js';
...
export interface IdentityModule {
  readonly useCases: {
    ...
    readonly addMembership: AddMembershipUseCase;
    readonly getMembership: GetMembershipUseCase;
    readonly activateMembership: ActivateMembershipUseCase;
    readonly suspendMembership: SuspendMembershipUseCase;
    readonly revokeMembership: RevokeMembershipUseCase;
  ...
  readonly routes: {
    readonly auth: FastifyPluginAsync;
  };
  readonly repositories: {
    readonly users: PostgresUserRepository;
    readonly refreshSessions: PostgresRefreshSessionRepository;
  };
}

export interface CreateIdentityModuleDeps {
