...
import { createProductBodySchema, listProductsQuerySchema, productContentListSuccessResponseSchema, productContentSuccessResponseSchema, productIdParamsSchema, productListSuccessResponseSchema, productLocaleParamsSchema, productSuccessResponseSchema, updateProductBodySchema, upsertProductContentBodySchema, } from './product.schemas.js';
...
const productRoutes = async (app, deps) => {
    const typed = app.withTypeProvider();
    typed.get('/api/v1/products', {
        schema: {
            tags: ['Products'],
    ...
    typed.get('/api/v1/products/:productId', {
        schema: {
            tags: ['Products'],
    ...
    typed.patch('/api/v1/products/:productId', {
        schema: {
            tags: ['Products'],
    ...
    typed.post('/api/v1/products/:productId/deactivate', {
        schema: {
            tags: ['Products'],
    ...
    typed.post('/api/v1/products/:productId/archive', {
        schema: {
            tags: ['Products'],
    ...
    typed.get('/api/v1/products/:productId/content', {
        schema: {
            tags: ['Products'],
    ...
    typed.put('/api/v1/products/:productId/content/:locale', {
        schema: {
            tags: ['Products'],
