...
import { createRequestContext, enrichRequestContext, enterRequestContext, } from '../../../shared/context/request-context.js';
...
const requestContextPlugin = async (app, options) => {
    app.addHook('onRequest', (request, reply, done) => {
        const requestId = resolveRequestId(request.headers[REQUEST_ID_HEADER], options.trustIncomingRequestId);
